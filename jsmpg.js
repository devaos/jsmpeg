...
var jsmpeg = window.jsmpeg = function( url, opts ) {
  ...
  this.externalMessageCallback = opts.onmessage || null;
  this.externalOpenCallback = opts.onopen || null;
...
jsmpeg.prototype.receiveSocketMessage = function( event ) {
  var messageData = new Uint8Array(event.data);
	...
	if( this.externalMessageCallback ) {
		this.externalMessageCallback(messageData);
	}
...
jsmpeg.prototype.dcPredictorY = 128;
jsmpeg.prototype.dcPredictorCr = 128;
jsmpeg.prototype.dcPredictorCb = 128;
